...
# from library.tools import get_quest_nr, find_file, nodes_list_from_tree
...
if not diagram_file_path:
    print(f'Nie ma w projekcie diagramu projektowego o nazwie: „{quest_names[0].split("_", 1)[0]}_diagram_{quest_names[0].split("_", 1)[-1]}.drawio”. Sprawdź nazwę diagramu lub testuj bez kolorowania przejścia.')
...
# Przetłumaczenie wartości dla klucza z pól: "Description", przetłumaczenie wartości atrybutów
# Przetłumaczenie "Name" oraz kluczy atrybutów i podmiana w ścieżkach instrukcji i preconditions.
# Przetłumaczenie drugiego członu tytułów
...
gp_folder = 'gameplays'
result_file_path = f'{script_root_path}/{gp_folder}/gp-{date_folder}__{quest_names[0]}'
...
gameplay = {
    ...
    "DiagramPath": diagram_file_path or '',
